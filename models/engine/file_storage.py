#!/usr/bin/python3
"""
    This is a file storage that serializes an
    instance to a JSON file (JSON.dump)
...
class FileStorage:
    """This class serializes instance to a JSON file and
    deserializes JSON to instance"""
